...
const MTC_GYM_CHALLENGES = [
  ...
  },
  {
    ...
    payload: {
      ...
      steps: [
        { ask: "Which parts of the request are warning signs of manipulation?", options: ["The demand for an answer tonight, the secrecy and the claim that saying no means I do not care", "The amount is exactly £600", "The person is a relative", "They asked for help instead of taking the money"], answer: 0, because: "Urgency reduces thinking time, secrecy removes outside advice and guilt turns a money decision into a test of love. Together they create pressure instead of evidence." },
        { ask: "What is the best first response?", options: ["I do not make money decisions under pressure. I am not lending the money", "Give me ten minutes to find a better excuse", "I will lend it if you promise not to ask again", "Explain every concern until they agree that my answer is fair"], answer: 0, because: "A clear boundary states the decision without opening a debate about whether your reason is good enough. You are allowed to say no without winning agreement." },
        { ask: "They reply, 'Family helps family. Why are you being selfish?' What do you do next?", options: ["Repeat the boundary once: I understand you are upset, but I am not lending the money", "List every time you have helped the family before", "Offer a smaller amount so they stop criticising you", "Call them selfish in return"], answer: 0, because: "Repeating the boundary avoids being pulled into a new argument. A long defence gives the other person more points to challenge and does not change your decision." },
        { ask: "They keep insulting you and refuse to accept the answer. What is the safest response?", options: ["End the conversation and leave or hang up. Contact someone you trust if you feel unsafe", "Stay until they understand why they are wrong", "Agree now and cancel the payment tomorrow", "Threaten them so they stop"], answer: 0, because: "You cannot force someone to respect a boundary. Ending the conversation protects you from more pressure. If there is a threat, get help rather than handling it alone." },
      ],
    },
    debrief: {
  ...
  },
  {
    ...
    payload: {
      ...
      steps: [
        { ask: "Which details are warning signs?", options: ["The urgent payment, secrecy and request to avoid other family members", "The caller sounds upset", "The call arrived during the day", "The amount is more than £1,000"], answer: 0, because: "Urgency reduces thinking time, while secrecy blocks the people most able to check the story. Together they deserve an independent check." },
        { ask: "What should you do first?", options: ["End the call and contact your grandchild or their parent using a number you already had", "Ask the caller to repeat your grandchild's name", "Keep them talking while you arrange the money", "Call the number shown on your screen back"], answer: 0, because: "Names and displayed phone numbers can be copied. A separate call to a trusted number breaks the caller's control of the check." },
        { ask: "You cannot reach your grandchild immediately. What now?", options: ["Wait and contact another trusted family member before sending anything", "Send half the money in case the story is real", "Ask the caller for a photograph", "Buy gift cards because they can be cancelled later"], answer: 0, because: "Not reaching someone is not proof of an emergency. Waiting protects the money while another trusted person checks the story." },
        { ask: "What information should you never give the caller?", options: ["Bank passwords, card codes or gift-card numbers", "Your grandchild's middle name", "The time you plan to call back", "The name of another family member"], answer: 0, because: "Passwords and payment codes can let another person take money immediately. A genuine relative does not need them to receive help." },
      ],
    },
    debrief: {
  ...
  },
  {
    ...
    payload: {
      ...
      steps: [
        { ask: "What can you honestly conclude?", options: ["I cannot know whether it was touched, so I should treat the uncertainty seriously", "Someone definitely put something in it", "It is safe because the glass looks unchanged", "It is safe if a friend was somewhere nearby"], answer: 0, because: "Appearance cannot settle what happened, and uncertainty is not proof of harm. It is enough reason to choose the safer option." },
        { ask: "What should you do with the drink?", options: ["Do not drink it. Replace it with one you watched being opened or prepared", "Taste a small amount first", "Ask a stranger nearby whether they saw anything", "Keep it but add more ice"], answer: 0, because: "Replacing one drink has a small cost. Tasting it cannot safely test for something you may not notice before it affects you." },
        { ask: "Who should you tell?", options: ["A trusted friend and the venue staff", "Nobody, because you have no proof", "Everyone at the party through a public accusation", "Only the person who poured the original drink"], answer: 0, because: "A trusted person can stay with you, and staff can help replace the drink or watch for a wider problem without making an unsupported accusation." },
        { ask: "You already drank some and suddenly feel unusually unwell. What now?", options: ["Tell someone immediately, seek urgent medical help and do not leave alone or drive", "Go home alone and sleep", "Wait an hour to see whether it passes", "Drink coffee and continue the evening"], answer: 0, because: "Sudden unusual symptoms need prompt help. Staying with a trusted person and avoiding driving reduces the risk while help is arranged." },
      ],
    },
    debrief: {
  ...
  },
  {
    ...
    payload: {
      ...
      steps: [
        ...
        { ask: "What should decide whether the loan is affordable?", options: ["Whether your real budget can pay the full amount on the due date without needing another loan", "Whether the lender approves the application", "Whether £500 solves today's problem", "Whether the weekly charge sounds small"], answer: 0, because: "Approval says the lender will offer the money, not that repayment fits your budget. A second loan can turn one shortfall into a growing cycle." },
      ],
    },
    debrief: {
  ...
  },
  {
    ...
    payload: {
      ...
      steps: [
        { ask: "What do you know for certain?", options: ["They presented an idea I sent them and did not mention my contribution", "They planned to damage my career", "The manager will never value my work", "Everyone in the meeting knew they were lying"], answer: 0, because: "The action is visible, but the motive is not. Starting from facts keeps your response accurate and easier for others to support." },
        { ask: "What can you say in the meeting?", options: ["I can add some detail from the draft I sent yesterday and explain how we developed this", "That is my idea and you stole it", "Say nothing and complain to other coworkers later", "Interrupt until the manager apologises"], answer: 0, because: "This makes your contribution visible and adds useful information without making a claim about intent that you cannot yet prove." },
        { ask: "What should you do after the meeting?", options: ["Speak privately, describe what happened and ask them to name your contribution next time", "Send an angry message to the whole team", "Take credit for their next idea", "Ignore it because raising it would look difficult"], answer: 0, because: "A direct private request gives the coworker a clear chance to correct the behaviour while creating a shared understanding for next time." },
        { ask: "The same thing happens again. What is the next reasonable step?", options: ["Keep the written examples and speak to the manager about the repeated behaviour and the change you need", "Publicly accuse them of lying in every future meeting", "Stop sharing all ideas with the team", "Resign immediately"], answer: 0, because: "A repeated pattern justifies a stronger response. Specific records help the manager address behaviour instead of choosing between two unsupported stories." },
      ],
    },
    debrief: {
