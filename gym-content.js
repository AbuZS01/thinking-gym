    ...
    payload: {
      ...
      decision: {
        ...
        options: [
          ...
          "Search every part of the shop in no set order",
          "Wait ten minutes in case the child returns on their own",
          "Ask the parent to finish shopping while one worker looks around",
        ],
        answer: 0,
  ...
  },
  {
    ...
    payload: {
      ...
      questions: [
        ...
        { text: "Has anyone turned every machine off and on again?", value: "low",
        ...
        { text: "Is the tape machine's motor hot?", value: "low",
          answer: "No.",
  ...
  },
  {
    ...
    payload: {
      ...
      questions: [
        ...
        { text: "How many years of the business's income does the price equal?", value: "low",
        ...
        { text: "What new services could the two businesses offer together?", value: "low",
    ...
    payload: {
      ...
      decision: {
        ...
        options: [
          ...
          "Use the change everywhere because a reported 22% improvement is too large to ignore",
  ...
  },
  {
    ...
    payload: {
      ...
      questions: [
        ...
        { text: "How much income does this customer bring in?", value: "low",
      ...
      decision: {
        ...
        options: [
          ...
          "Pull everyone in the company onto the problem and stop all planned work",
  ...
  },
  {
    ...
    payload: {
      ...
      questions: [
        ...
        { text: "Why are the current tenants leaving?", value: "low", answer: "They say the tenants found jobs in another city.", because: "The story may sound believable, but it does not prove that the room or the person is genuine." },
        { text: "Is the room furnished?", value: "low", answer: "They say it includes everything shown in the photographs.", because: "Scammers can copy photographs and descriptions from a real advert. This answer does not make payment safer." },
        { text: "Would you reduce the rent if I pay six months now?", value: "low", answer: "Yes. They offer a larger discount for paying immediately.", because: "A bigger discount increases the pressure to pay. It does not prove that the offer is real." },
      ],
      decision: {
        ask: "What do you do?",
        options: ["Do not pay, stop contact and report the advert to the website", "Pay the £250 because losing a good room would cost more", "Send half now and half after the keys arrive", "Ask for a photograph of their identity card, then pay"],
        answer: 0,
  ...
  },
  {
    ...
    payload: {
      ...
      questions: [
        ...
        { text: "Why is the phone so cheap?", value: "low", answer: "They say they need money for a family emergency.", because: "A believable reason for the price does not prove the seller owns the phone." },
        { text: "How long have you owned it?", value: "low", answer: "They say three months.", because: "The answer is easy to invent and gives you no way to verify the item or payment." },
        { text: "When will the other buyer pay?", value: "low", answer: "They say within the next hour.", because: "The claimed buyer increases urgency but does not make the transaction safer." },
      ],
      decision: {
        ask: "What do you do?",
        options: ["Do not transfer money, keep communication on the app and report the listing", "Transfer a small deposit so the seller holds it", "Ask for a photograph of the phone beside today's newspaper, then transfer", "Pay quickly because the discount covers the risk"],
        answer: 0,
  ...
  },
  {
    ...
    payload: {
      ...
      questions: [
        ...
        { text: "Are they wearing a uniform?", value: "low", answer: "Yes, with the company's name on it.", because: "Clothing can be bought or copied and does not connect the person to the company." },
        { text: "Is there a company van outside?", value: "low", answer: "There is a white van with a removable company sign.", because: "A sign on a vehicle is easy to copy and does not verify the person at the door." },
        { text: "Do they know my surname?", value: "low", answer: "Yes. It appears with the address on letters near the door.", because: "Knowing information visible at the property does not prove official access." },
      ],
      decision: {
        ask: "What do you do?",
        options: ["Keep the door locked, end the conversation and seek help if the person refuses to leave", "Open the door but keep them in the hallway", "Ask to photograph their identity card, then let them in", "Let them inspect one room because a gas problem could be urgent"],
        answer: 0,
