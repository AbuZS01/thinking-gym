...
const MTC_FRAMEWORKS = [
  ...
  },
  {
    ...
    danger: "Can become an intellectualised form of procrastination — analyzing your thinking instead of doing the thinking.",
...
const MTC_TOOLBOX = [
  ...
  { id: "pareto", name: "Pareto Principle (80/20)", summary: "Roughly 80% of effects often come from 20% of causes.", when: "Prioritising effort when time is short and a few causes account for most of the effect." },
  ...
  { id: "feynman", name: "Feynman Technique", summary: "Explain a concept in plain language as if teaching a child; gaps reveal what you don't actually understand.", when: "Checking whether you truly understand something or just recognise it." },
  ...
  { id: "eisenhower", name: "Eisenhower Matrix", summary: "Sort tasks by urgent/important into four quadrants to decide what to do, schedule, delegate, or drop.", when: "Prioritising a to-do list that is being driven by what is loudest, not by what matters." },
  ...
  { id: "feedback-loops", name: "Feedback Loops", summary: "Reinforcing loops amplify change; balancing loops resist it — most system behaviour comes from these.", when: "Understanding why a system self-stabilises or spirals despite one-off interventions." },
  ...
  { id: "circle-of-competence", name: "Circle of Competence", summary: "Know the boundary of what you actually understand well, and stay inside it (or flag when you don't).", when: "Deciding whether your own judgement can be trusted on this particular subject." },
  ...
  { id: "anchoring", name: "The First Number Sticks", formalName: "Anchoring", summary: "The first number or suggestion you hear pulls your thinking towards it, even when it has nothing to do with the question.", when: "Judging a price, offer, estimate or negotiation after someone else has named a number first." },
