...
assert.equal(challenges.length, 136, "README and onboarding count must match the content bank");
...
assert.deepEqual(
  ...
  { adapt: 24, connect: 14, judge: 33, notice: 29, prioritise: 17, question: 19 },
